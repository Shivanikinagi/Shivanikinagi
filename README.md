...
🚀 **3x Hackathon winner | AI & ML Developer | Generative AI Practitioner | NLP + LLM Engineer | Agentic AI**
...
🔥 I’m an **AI & ML Developer** obsessed with pushing machines beyond their limits—specializing in **LLMs, NLP, and AI automation**.  
🚀 I craft intelligent applications using **Flask**, **Django**, and **Streamlit**, backed by a rock-solid foundation in **data preprocessing, modeling, optimization, and deployment**.  
🧠 My mission is to build **AI systems so practical and reliable they feel unreal**, powered by **curiosity, clarity, and just the right amount of madness** to create things people don’t expect.
...
[![Twitter](https://img.shields.io/badge/X-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/Shivani824018)
